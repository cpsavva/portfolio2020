// websites
// Cancer Alliance : https://cancer-alliance.herokuapp.com/
// Got Bored?: https://fam-app-94e72.firebaseapp.com
// TrailBlazer: https://trailblazer-rcb.herokuapp.com
// NPR Scrapping: https://npr-scrape.herokuapp.com
 ...
 var modalInfo = [
	{
		...
		alt : 'Cancer Alliance',
		site : 'https://github.com/cpsavva/gitgirls2',
...

	{
		...
		alt : 'Got Bored?',
		site : 'https://github.com/cpsavva/fam-app',
	...
	},
	{
		...
		alt : 'TrailBlazer',
		site : 'https://github.com/cpsavva/trailblazer',
	...
	},
	{
		...
		alt : 'NPR Scrapping',
		site : 'https://github.com/cpsavva/npr_scrapping',
		...
		$('.projButton').click(function() {
			...
			// console.log(modalInfo[projName].projectName)
				$('.modalInfo').html(		        
				    ...
				    '" target="_blank">GitHub</a></p></div><div class="col-sm-8"><p>' 
